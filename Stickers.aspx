<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Stickers.aspx.cs" Inherits="Stickers" %>
...
<body>
 ...
 <div data-i18n="Boxicons">GPS FastTag</div>
                               ...
                               <div class="card-header d-flex justify-content-between align-items-center">
                                     <div class="row">
                                         <div class="col-md-6 mb-3">
                                             <div class="card" style="background: #5f61e6; border-radius: 5px; color: white;width:200px;">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-sm-2">
                                            ...
                                            <div class="input-group mb-3">
                                                <div class="input-group-text">
                                                    <input class="form-check-input mt-0 Sstickerdim" name="stickers" sattr="Small" type="radio" value="Small" />
                                                </div>
                                        ...
                                        <div class="mb-3 col-sm-2">
                                            ...
                                            <div class="input-group mb-3">
                                                <div class="input-group-text">
                                                    <input class="form-check-input mt-0 Mstickerdim" name="stickers" sattr="Medium" type="radio" value="Medium" />
                                                </div>
                                        ...
                                        <div class="mb-3 col-sm-2">
                                            ...
                                            <div class="input-group mb-3">
                                                <div class="input-group-text">
                                                    <input class="form-check-input mt-0 Lstickerdim" name="stickers" sattr="Large" type="radio" value="Large" />
                                                </div>
    ...
    <script> /* get location  or vehicale number phone number     */
       ...
       document.addEventListener("DOMContentLoaded", function () {
           ...
           function limitInput(event) {
               ...
               if (inputValue < minValue || inputValue > maxValue) {
                   alert('Please enter only 1 and 2');
                   event.target.value = minValue;
               }

               updateTotalStickerCount();
           }
           ...
           function updateTotalStickerCount() {
               ...
               const totalStickerCount = smallCount + mediumCount + largeCount;

               stickerSizeInput.value = totalStickerCount;
           }
       });
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            if (defaultTab) {
                ...
                console.error("Element with ID 'defaultTab' not found.");
            }
        });
