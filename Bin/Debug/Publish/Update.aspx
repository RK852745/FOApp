<%@ page language="C#" autoeventwireup="true" inherits="Update, App_Web_ptk2nwqr" %>
...
<body>
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="card mb-4">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h5 class="mb-0">Update Visiting Details</h5>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-sm-4">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text" class="form-control" name="name" minlength="2" id="FullName" placeholder="First & last Name" aria-label="John Doe" aria-describedby=" ">
                                        </div>
                                    </div>
                                    <div class="mb-3 col-sm-4">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="number" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" id="phone" maxlength="10" pattern="\d{10}" class="form-control phone-mask" placeholder="658 799 8941" aria-label="658 799 8941" aria-describedby="phone2">
                                        </div>
                                    </div>
                                    <div class="mb-3 col-sm-4">
                                    ...
                                    <div class="mb-3 col-sm-3">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text" id="Company" class="form-control" placeholder="Company" aria-label="Company" aria-describedby="Company">
                                        </div>
                                    </div>
                                    <div class="mb-3 col-sm-3">
                                  ...
                                  <%--  <div class="mb-3 col-sm-4">
                                        ...
                                        <div class="input-group">
                                            <input type="file" class="form-control uploadimagefile" accept="image/png, image/gif, image/jpeg" typefor="3" id="inputGroupFilevisitingcard">
                                        </div>
                                    ...
                                    <div class="col-sm-8">
                                        <div class="row">
                                            ...
                                            <div class="mb-3 col-sm-4">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    <span id="" class="input-group-text"><i class="fa fa-truck"></i></span>
                                                    <input type="number" class="form-control" id="vehicleCount" value="" placeholder="" aria-label="John Doe" aria-describedby="" />
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="row">
                                            ...
                                            <div class="mb-3 col-sm-4">
                                                ...
                                                <div class="input-group">
                                                    <input type="file" class="form-control uploadimagefile" accept="image/png, image/gif, image/jpeg" typefor="1" id="inputGroupFileSticker">
                                                </div>
                                                <div id="imagePreview1" class="row  mt-3">
                                                </div>
                                            </div>
                                            <div class="mb-3 col-sm-4">
                                                <label class="form-label" for="inputGroupFileowner">Upload image with owner</label>
                                                <div class="input-group">
                                                    <input type="file" class="form-control uploadimagefile" accept="image/png, image/gif, image/jpeg" typefor="2" id="inputGroupFileowner">
                                                </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-sm-4">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <textarea style="height: 100px;" type="text" id="Remarks" class="form-control" placeholder="Remarks" aria-label="Remarks" aria-describedby=""></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <button id="updatebtn" onclick="fnUpdateBtn($(this));" class="btn btn-primary w-100">Update</button>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <%--<script src="js/VehicleRegistrationHelper.js"></script>--%>
    <script src="js/UpdateHelper.js"></script>
</body>
</html>
